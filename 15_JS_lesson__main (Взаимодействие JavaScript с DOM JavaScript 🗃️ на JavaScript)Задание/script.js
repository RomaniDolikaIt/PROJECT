...
// 1. Находим нужный элемент на странице (например, по ID)
const box = document.querySelector('#myBox');

// 2. Переключаем класс 'active'
// Если он был — он исчезнет, если его не было — он появится
box.classList.toggle('active');

// 3. Проверяем наличие класса в консоли
// Метод contains возвращает true (есть) или false (нет)
console.log('Есть ли у элемента класс "active"?', box.classList.contains('active'));